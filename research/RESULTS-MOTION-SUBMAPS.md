...
That keyframe-count/overlap policy remains retired. Temporal mode is the default;
a separate [spatial displacement policy](RESULTS-SPATIAL-SUBMAPS.md) is now available.
