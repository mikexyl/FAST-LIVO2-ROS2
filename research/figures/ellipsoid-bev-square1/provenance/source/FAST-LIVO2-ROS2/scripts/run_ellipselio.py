...
def main():
    ...
    params['research']=dict(params.get('research',{}),enabled=True,robot=args.robot,python=str(source/'.ros2/research-venv/bin/python'),
        writer=str(source/'FAST-LIVO2-ROS2/research/s3e_pipeline/mcap_writer.py'),output=str(out/'export'))
