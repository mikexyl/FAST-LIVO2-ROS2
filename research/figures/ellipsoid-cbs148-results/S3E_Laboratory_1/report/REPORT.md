# S3E_Laboratory_1: EllipseLIO + ellipsoid MapClosures + PCM/CBS
...
|---|---:|---:|
| Alpha | unavailable | unavailable |
| Bob | unavailable | unavailable |
| Carol | unavailable | unavailable |
...
PCM: **46 proposed / 44 retained / 2 excluded**. PCM applies to inter-robot measurements; verified intra-robot loops pass unchanged.

Components: `{'Alpha': 'Alpha', 'Bob': 'Bob', 'Carol': 'Bob'}`. Detection/PCM/CBS wall time: **18.64 s**.
