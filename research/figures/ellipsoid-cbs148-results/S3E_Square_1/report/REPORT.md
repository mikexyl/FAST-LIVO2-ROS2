...
PCM: **55 proposed / 55 retained / 0 excluded**. PCM applies to inter-robot measurements; verified intra-robot loops pass unchanged.

Components: `{'Alpha': 'Alpha', 'Bob': 'Alpha', 'Carol': 'Alpha'}`. Detection/PCM/CBS wall time: **76.85 s**.
