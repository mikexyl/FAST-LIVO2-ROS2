...
export ROS_LOG_DIR=/tmp/graco-gravity-build-ros
B=/workspace/.ros2/graco-aerial-gravity148-20260920
...
mkdir -p /opt/graco-gravity-mapclosures
cp "$B"/mapclosures/s3e_mapclosures_native*.so /opt/graco-gravity-mapclosures/
