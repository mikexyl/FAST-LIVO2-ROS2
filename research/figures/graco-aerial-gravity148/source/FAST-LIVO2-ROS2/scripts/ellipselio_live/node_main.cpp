...
#define NODE_MAIN_LOGGER_NAME "ellipselio_mapping_node"

int main(int argc, char * argv[])
{
  auto args = rclcpp::init_and_remove_ros_arguments(argc, argv);
  rclcpp::Logger logger = rclcpp::get_logger(NODE_MAIN_LOGGER_NAME);
  // Keep native publishing callbacks from blocking sensor processing.
  ...
  std::string library_name = "libellipselio_mapping.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ellipselio::MappingNode>";
