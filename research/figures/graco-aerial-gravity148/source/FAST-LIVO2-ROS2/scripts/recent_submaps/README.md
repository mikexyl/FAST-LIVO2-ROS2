...
The active implementation supports temporal submapping only. The motion/overlap
experiment was reverted locally at the user's request; its source, configuration
and reports remain under `research/figures/motion-submaps` as historical evidence.
