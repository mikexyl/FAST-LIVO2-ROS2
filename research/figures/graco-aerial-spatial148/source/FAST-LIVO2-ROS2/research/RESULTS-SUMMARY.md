...
Updated 2026-09-20. This document consolidates the completed **MegaLoc +
MapClosures + distributed CBS** experiments for Alpha, Bob and Carol.

**Active EllipseLIO submapping is temporal only: 10 seconds with 5 seconds overlap.**
The motion/overlap implementation was reverted locally at the user's request;
historical code and experiment artifacts are retained.
