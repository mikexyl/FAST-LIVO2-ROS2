...
void MappingNode::InsertWorldScan() {
  ...
  if (submaps_enabled_) {
    ...
    if (submap_distance_metric_ == "horizontal")
...
MappingNode::MappingNode(
  ...
  if (submap_strategy_ != "temporal" && submap_strategy_ != "spatial")
    throw std::invalid_argument("Submap strategy must be temporal or spatial");
