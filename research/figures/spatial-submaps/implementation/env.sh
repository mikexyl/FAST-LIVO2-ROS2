...
source .ros2/spatial-submaps-20260920/install/ellipselio/share/ellipselio/local_setup.bash
export CBS_UNDERLAY=/home/mikexyl/workspaces/sb_slam_ros2_ws/install
export PYTHONPATH="$PWD/FAST-LIVO2-ROS2/research:${PYTHONPATH:-}"
...
export ROS_LOG_DIR=/tmp/ellipselio-spatial-ros
