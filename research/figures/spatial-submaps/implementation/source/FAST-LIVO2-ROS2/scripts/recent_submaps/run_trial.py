...
p.add_argument('--submap-strategy',choices=['temporal','spatial'],
               help='Enable native submapping with this strategy; spatial defaults come from spatial_submaps.yaml')
...
if args.submap_strategy:
    ...
    if args.submap_strategy=='spatial':
        defaults=yaml.safe_load((root/'FAST-LIVO2-ROS2/scripts/recent_submaps/spatial_submaps.yaml').read_text())
        submaps['spatial']=dict(defaults['spatial'],**submaps.get('spatial',{}))
